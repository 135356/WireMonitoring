...
#ifndef WM_WIREM_UPLOADFILE_HPP
#define WM_WIREM_UPLOADFILE_HPP
#include "mysql_orm/sql/dql.h"

class wireM_uploadFile:public bb::dql{
    wireM_uploadFile(){
        if(run_() != 0){
...
public:
    static wireM_uploadFile &obj(){
        static wireM_uploadFile wire_m_upload_file;
